...
function ScoreCard({ partido }: { partido: PartidoConClubes }) {
  ...
  return (
    <div className="flex-shrink-0 w-72 snap-center bg-lab-surface rounded-lg border border-lab-border overflow-hidden hover:border-lab-gold/30 transition-colors">
      {/* Header */}
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-2">
        <div
          className="w-6 h-6 rounded-sm flex items-center justify-center font-display text-xs"
          style={{ backgroundColor: colores.primario, color: colores.secundario }}
        >
          {nombre[0]}
        </div>
