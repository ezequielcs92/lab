    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8">
        ...
        <HistorySection
          decade="2025"
          title="El Presente"
          content="La Liga integra siete equipos: Falcons y Arias, de Córdoba, Infernales y Cachorros, de Salta y DAOM, Patriots y Vélez, de Buenos Aires. En la temporada 2025, el campeón Club DAOM representó a la Argentina en la Serie de las Américas 2026 disputada en Venezuela. Hoy la LAB es el principal escenario competitivo del béisbol nacional y una plataforma que conecta el talento local con el desarrollo internacional del deporte."
        />
      </div>
    </div>
  )
